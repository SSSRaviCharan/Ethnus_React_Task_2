      ...
      <div className="calculator-container">
        <div className="calculator">
          ...
          <div className="buttons">
            <div className="row">
              <button className="click" onClick={() => handleButtonClick("7")}>
                7
              </button>
              <button className="click" onClick={() => handleButtonClick("4")}>
                4
              </button>
              <button className="click" onClick={() => handleButtonClick("1")}>
                1
              </button>
              <button className="click" onClick={() => handleButtonClick("0")}>
                0
              </button>
            </div>
            <div className="row">
              <button className="click" onClick={() => handleButtonClick("8")}>
                8
              </button>
              <button className="click" onClick={() => handleButtonClick("5")}>
                5
              </button>
              <button className="click" onClick={() => handleButtonClick("2")}>
                2
              </button>
            ...
            <div className="row">
              <button className="click" onClick={() => handleButtonClick("9")}>
                9
              </button>
              <button className="click" onClick={() => handleButtonClick("6")}>
                6
              </button>
              <button className="click" onClick={() => handleButtonClick("3")}>
                3
              </button>
              <button className="click" onClick={() => handleButtonClick("=")}>
                🟰
